...
class TweetSpiderByKeyword(Spider):
    ...
    base_url = "https://uland.taobao.com/sem/tbsearch?clk1=72ce882e5792680ccc98c43c7dd3d6ba&keyword=%E5%88%B9%E8%BD%A6%E7%89%87&localImgKey=&msclkid=003e09ef4ddf14f19c7860e750a39b13&page=1&q=%E5%88%B9%E8%BD%A6%E7%89%87&refpid=mm_2898300158_3078300397_115665800437&tab=all&upsId=72ce882e5792680ccc98c43c7dd3d6ba/"
    ...
    def start_requests(self):
        ...
        products_name = settings.KEYWORD_ids
        # 这里的时间可替换成实际需要的时间段
        # start_time = datetime.datetime.strptime(settings.START_TIME, '%Y-%m-%d-%H')
        # # start_time = datetime.datetime(year=2022, month=10, day=1, hour=0)
        # end_time = datetime.datetime.strptime(settings.END_TIME, '%Y-%m-%d-%H')
