...
def parse_tweet_info(data):
    ...
    tweet = {
        ...
        "pic_urls": ["https://wx3.sinaimg.cn/orj960/" + pic_id+'.jpg' for pic_id in data.get('pic_ids', [])],
        "pic_num": data['pic_num'],
        'isLongText': False,
        'is_retweet': False,
        "user_id": user['user_id'],
        "user_avatar_hd": user['avatar_hd'],
    ...
    if 'page_info' in data and data['page_info'].get('object_type', '') == 'video':
        ...
        tweet['video']=None
        tweet['video_online_numbers'] = None
